...
const HomePage = () => {
  return (
    <MainLayout isFullWidth>
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-linear-to-br from-primary to-primary/80 py-20 text-primary-foreground text-center">
      ...
      <section className="py-16">
        <div className="container px-4 md:px-6 mx-auto max-w-6xl">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card className="p-6 transition-all hover:shadow-lg md:col-span-2 lg:col-span-1">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10">
